class Game {
  ...
  handleElements() {
    ...
    this.leadeboardTitle.html("tabla de puntuacion");
...
if((players[0].rank === 0 && players[1].rank === 0) || 
 ...
 } if (keyIsDown(LEFT_ARROW) && player.positionX > width / 3 - 50) { player.positionX -= 5; player.update(); } if (keyIsDown(RIGHT_ARROW) && player.positionX < width / 2 + 300) { player.positionX += 5; player.update(); } }
